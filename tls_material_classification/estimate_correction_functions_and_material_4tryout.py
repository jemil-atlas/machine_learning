...
f_vals_model = f_model(r_points.T, latent_z_trained).reshape([n_stations, n_points])
g_vals_model = g_model(phi_points.T, latent_z_trained).reshape([n_stations, n_points])
