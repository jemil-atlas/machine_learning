...
classification_error_matrix=np.zeros([n_cases,n_cases_wavelengths])
...
for k in range(n_cases):
    ...
    for m in range(n_cases_wavelengths):
        ...
        classification_error_matrix[k,m]=np.sum(lin_svm_error_vec)
...
im=plt.imshow(classification_error_matrix)
plt.colorbar(im)
